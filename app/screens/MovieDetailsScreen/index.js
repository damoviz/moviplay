...
const renderTruncatedFooter = handlePress => (
  <TouchableOpacity onPress={handlePress}>
    <Text style={styles.readMore}>Lee mas</Text>
  </TouchableOpacity>
);
...
export default class MovieDetailsScreen extends Component {
  ...
  getInfosDetail = ({
    ...
    return {
      Duración: this.convertMinsToHrsMins(runtime || 0),
      Género: this.convertToGenre(this.sliceArrayLength(genres, 2) || ''),
      Idioma: this.convertToUpperCaseFirstLetter(
        language[original_language] || ''
      ),
      Lanzamiento: this.convertToDate(release_date || ''),
      Presupuesto: this.convertToDolar(budget || 0),
      Ingresos: this.convertToDolar(revenue || 0),
      Adulto: this.convertAdult(adult || '')
    };
  };
        ...
        {isLoading ? (
          ...
          <ScrollView>
            ...
            <View style={styles.containerMovieInfo}>
              ...
              <SectionRow title="Equipo técnico">
                <PersonListRow
                  data={crew}
                  type="job"
                  keyItem="creditId"
              ...
              <SectionRow title="Productor" isLast>
                <PersonListRow
